    ...
    >
      <div className="container mb-2.5">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <div className="w-30 h-14 rounded-lg flex items-center justify-center shadow-sm overflow-hidden group-hover:shadow-lg group-hover:scale-105 transition-all duration-300 relative">
              {/* Logo glow effect */}
