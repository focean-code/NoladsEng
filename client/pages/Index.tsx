...
export default function Index() {
  ...
  useSEO({
    ...
    description:
      "Leading electrical engineering company specializing in power systems design, industrial automation, safety solutions, and performance monitoring for industrial applications.",
    keywords:
      "electrical engineering, power systems design, industrial automation, safety solutions, electrical safety, PLC programming, SCADA systems, power distribution, electrical consulting",
                ...
                <div className="text-center relative flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-center gap-4 animate-slide-in-up delay-1200">
                      {testimonials[currentTestimonial] &&
                      typeof testimonials[currentTestimonial].avatar !==
                        "undefined" ? (
                      ...
                      <div className="text-left">
                        <div className="font-semibold text-slate-900 text-base">
                          {testimonials[currentTestimonial] &&
                          typeof testimonials[currentTestimonial].name !==
                            "undefined"
                        ...
                        <div className="text-slate-600">
                          {testimonials[currentTestimonial] &&
                          typeof testimonials[currentTestimonial].title !==
                            "undefined"
                        ...
                        <div className="text-blue-600 font-medium">
                          {testimonials[currentTestimonial] &&
                          typeof testimonials[currentTestimonial].company !==
                            "undefined"
