...
export const mockServices: Service[] = [
  ...
  },
  {
    ...
    description: 'Complete generator installation and maintenance services for backup power solutions',
    short_description: 'Generator installation services',
    category: 'Installation',
    price_range: '$10,000 - $100,000',
    image_url: '/placeholder.svg',
    features: JSON.stringify(['Generator Setup', 'Transfer Switch Installation', 'Maintenance Plans']),
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  }
